...
image: https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/FriendZone.png
---
...
![etc-hosts](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/etc-hosts.png)

### enum4linux

`enum4linux` identified a username:

![user friend found](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/smb-user-friend.png)

### ftp (ports 21)

![ftp](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/ftp.png)
...
![creds](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/445-creds.png)
...
![web](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/80.png)

Another domain name: `friendzoneportal.red`.

![dirb](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/80-dirb.png)

- **robots.txt**:

![robots.txt](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/80-robots-txt.png)

#### `/wordpress`

![wordpress](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/80-wordpress.png)

### fiendzone.red (ports 443)

![friendzone.red](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/friendzone-red.png)

![view-source friendzone.red](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/443-comment.png)

![friendzone.red /js/js](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/443-js-js.png)

#### `/admin`

![friendzone.red](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/443-admin.png)

### friendzoneportal.red (ports 443)

> Do not forget to update `/etc/hosts`

![friendzoneportal](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/443-friendzoneportal.png)

![dirb friendzoneportal](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/443-friendzoneportal-dirb.png)
...
![admin panel](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin-panel.png)

We're successfully logged in with the credentials found via [smb](#smb-ports-139--445), but:

![admin panel successfully logged in](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/success.png)

_"check for another one"_, let's try with `dirb`.

Unfortunately:

![nothing](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/nothing.png)
...
![subdomains](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/subdomains.png)

![aquatone](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/aquatone.png)
...
![uploads](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/uploads.png)

I uploaded a benign picture and it seems that the upload worked: 

![uploads](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/upload.png)
...
![uploads](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/uploads-dirb.png)

### administrator1.friendzone.red

The credentials found via [smb](#smb-ports-139--445) worked as well on this second admin panel:

![second admin panel](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin1.png)

![login done](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin1-login-done.png)

- `/dashboard.php`:

![smart photos](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin1-smart-photos.png)
...
![bug](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin1-smart-photos-bug.png)

I replaced `image_id`'s value by `a.jpg` and I got this result:

![haha](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin1-haha.png)
...
![haha](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin1-timestamp.png)

I replaced `pagename`'s value by `dashboard` and the page was continuously including itself: 

![haha](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/admin1-double-inclusion.png)
...
![smb put shell.php](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/smb-put.png)
...
![reverse-shell](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/reverse-shell.png)
___
...
![linpeas-writable-files](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/linpeas-writable-files.png)
...
![pspy](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/pspy.png)
...
![root flag](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/friendzone/root-flag.png)
