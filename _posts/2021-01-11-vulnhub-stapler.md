...
image: https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/Stapler.png
---
...
![netdiscover](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/netdiscover.png)
...
![nmap scan vuln](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/nmap-vuln-scan.png)
...
![nmap-os-detection](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/nmap-os-detection.png)

### HTTP (Port 80)

![PHP cli server 5.5 (port 80)](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/80.png)

#### `gobuster`

![gobuster](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/80-gobuster.png)

Nothing looks interesting yet. Let's check out other ports.

#### `nikto`

![nikto](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/80-nikto.png)

### FTP (port 21)

We can log in as `anonymous` within `ftp`:

![FTP](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/21-ftp.png)
...
![todo list](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/139-smb-todo-list.png)
...
![DNS](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/53-dig.png)
...
![](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380.png)

If we check the sources we can see another user (**Tim**):

![](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-sources.png)

#### `nikto`

![](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-nikto.png)
...
![](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-gobuster.png)
...
![announcements](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-announcements.png)

![message](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-announcements-message.png)

Another potential user: **Abby**.

#### `/blogblog`

![blogblog initech](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/john-smith.png)

**John Smith** is the author of all posts!

First, I took a look at HTTP Response Headers to see if we can get any information:

![dave](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-dave.png)
...
![wordpress](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-wordpress.png)
...
![blogblog gobuster](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-blogblog-gobuster.png)
...
![Wordpress user](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-users.png)
...
![user creds](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-users-creds.png)

Let's try to lo in:

![wp-login](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/12380-wp-login.png)

We're in:

![harry dashboard](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/harry.png)
...
![john wp-admin](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/wp-admin.png)
...
![plugins](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/plugins.png)

![add plugin](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/add-plugins.png)

We specify `anonymous` as username and password:

![install plugin](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/install-plugins.png)
...
![uploaded plugin](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/uploaded-plugin.png)

If we click on it, PHP is executed by the web server and we got a shell:

![reverse shell](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/reverse-shell.png)
...
![linpeas](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/cron-logrotate.png)

![cron-logrotate content](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/cron-logrotate-1.png)
...
![reverse shell payload](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/cron-logrotate-2.png)

It worked:

![reverse shell as root](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/cron-logrotate-root.png)

### Method #2: .bash_history

If we inspect `.bash_history` files of each user in `/home`, we can identify these two lines:

![bash_history](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/bash_history.png)
...
![peter-sudo](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/peter-sudo.png)

### Method #3: kernel exploit

![ubuntu 16-04](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/ubuntu-16-04.png)
...
![searchsploit](https://pymaster-ft.github.io/assets/img/vulnhub/linux/stapler/searchsploit.png)
