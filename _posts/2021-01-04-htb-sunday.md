...
image: https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/Sunday.png
---
...
![finger users top usernames](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/finger-users.png)
...
![finger users more usernames](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/finger-users-2.png)
...
![74400 sha256 unix](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/man-hashcat.png)

![hashcat](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/hashcat.png)

Sammy's password is `cooldude!`.

## User (sammy)

![sammy ssh](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/sammy-ssh.png)
...
![wget gtfobins](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/wget-gtfobins.png)
...
![reverse shell failed](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/reverse-shell-failed.png)

However there are other things that we can probably do.

1. We can **read** every file: 

![/etc/shadow](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/etc-shadow.png)

2. We can **overwrite** the `/root/troll` binary

## Root

![root](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/sunday/root.png)
