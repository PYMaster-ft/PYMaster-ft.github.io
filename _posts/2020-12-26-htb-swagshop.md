...
image: https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/SwagShop.png
---
...
![shop](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/shop.png)
...
![strange](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/strange.png)

Thereby, I ran `dirb`:

![dirb](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/dirb.png)

And we found an admin panel on [http://10.10.10.140/index.php/admin](http://10.10.10.140/index.php/admin):

![admin-panel](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/admin-panel.png)
...
![rce](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/rce.png)

An it worked:

![worked](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/worked.png)

I logged in and I didn't understand why I was redirected to this page first:

![png](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/png.png)
...
![magento-admin-panel](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/magento-admin-panel.png)

#### `magescan`

At this point, I looked for _"magento scanners"_ and I found this [one](https://github.com/steverobbins/magescan) (`magescan`):

![magescan-2](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/magescan-2.png)

![magescan-1](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/magescan-1.png)
...
![credentials](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/creds.png)
...
![exploit 2 args](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/exploit-2-help.png)

![config exploit 2](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/exploit-2-config.png)

Then I encountered this error:

![error 2 exploit 2](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/exploit-2-error-2.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/2y.png)
...
![exploit worked](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/success.png)
...
![sh](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/sh.png)

![reverse-shell](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/reverse-shell.png)

Now that we have an acces to the machine's shell, let's do enumeration with **linpeas.sh**:

![sudo -l](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/linpeas.png)
...
![harris](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/haris.png)
...
![root](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/swagshop/root.png)
