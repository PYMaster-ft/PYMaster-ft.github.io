...
image: https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/Tabby.png
---
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/80.png)

Second thing we can notice is that **data breach** statement that redirects to <http://megahosting.htb/news.php?file=statement>.

![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/data-breach-link.png)

![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/data-breach.png)

Due to the `.php?file=statement`, I wanted to try for LFI and it works: 

<http://megahosting.htb/news.php?file=../../../../../../../../../../../>

![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/LFI.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/tomcat9.png)

Via `gobuster` and `dirb`, we see that there some "hidden" folders like `/manager`. Accessing this page requires credentials: 

![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/gobuster-8080.png)
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/auth.png)
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/8080-manager.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/tomcat-install-dir.png)
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/askubuntu.png)
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/creds.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/acces_denied.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/reverse_shell.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/john.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/lxd_group.png)
...
![](https://pymaster-ft.github.io/assets/img/htb/machines/linux/easy/tabby/lxd_privesc.png)
