...
image: https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/PwnLab.jpg
---
...
![netdiscover](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/netdiscover.png)
...
![](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/nikto.png)

#### Web page

- `index.php`: 

![index.php](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/Pwnlab.png)

- `upload.php`:

![upload.php](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/upload.png)

- `login.php`:

![login.php](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/login.png)
...
![LFI php filter](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/lfi-php-filter.png)
...
![mysql](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/mysql.png)
...
![upload images](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/upload-logged.png)
...
![ping.gif location](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab-src.png)
...
![lang cookie](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/lang-ping.png)
...
![reverse shell](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/reverse-shell.png)

![nc](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/nc.png)
...
![main ghidra](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/ghidra.png)
...
![nc msg2root](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/nc-msg2root.png)

Using `ghidra`'s decompiler:

![ghidra msg2root](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/ghidra-msg2root.png)
...
![bash -p option](https://pymaster-ft.github.io/assets/img/vulnhub/linux/pwnlab/bash-p.png)
